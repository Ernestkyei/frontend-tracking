      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Four steps. <span className="text-emerald-700">Zero guesswork.</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          ...
          {/* Step 4 */}
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
            <div className="text-4xl font-bold text-emerald-700 mb-4">04</div>
        ...
        <div className="bg-gradient-to-r from-emerald-800 to-teal-800 rounded-3xl p-12 mb-16 text-center">
          ...
          <div className="max-w-2xl mx-auto">
            <form className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 px-6 py-4 text-lg rounded-xl border-2 border-white bg-white focus:outline-none focus:border-emerald-300 focus:ring-2 focus:ring-emerald-200"
              />
              <button
                type="submit"
                className="px-8 py-4 bg-white text-emerald-700 text-lg font-semibold rounded-xl hover:bg-gray-100 transition-colors"
              >
                Track
              </button>
            </form>
        ...
        <div className="text-center">
          ...
          <button className="inline-flex items-center gap-2 bg-emerald-700 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-emerald-800 transition-colors">
            Send a package →
          </button>
        </div>
      </div>
