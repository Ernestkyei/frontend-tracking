        ...
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <div className="max-w-2xl mx-auto">
            <form onSubmit={handleTrackSubmit} className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-6 py-4 text-lg border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition-colors"
                  disabled={isLoading}
                />
                {error && (
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="px-8 py-4 bg-blue-600 text-white text-lg font-semibold rounded-lg hover:bg-blue-700 transition-colors disabled:bg-blue-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
            ...
            {/* <p className="text-sm text-gray-500 mt-4">
              Try: TRK123456, TRK789012, TRK345678
            </p> */}
          </div>
        </div>
      </section>
